...
* [install-codewhisperer-extension](scripts/install-codewhisperer-extension) - This script installs a codewhisperer extension package in SageMaker Notebook Instance.
